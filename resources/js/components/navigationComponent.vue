  ...
  <div class="flex">
    ...
    <div class="rounded-4xl my-auto py-auto mx-3">
      <form @submit.prevent="search" class="flex">
       ...
       <button type="submit" class="capitalize bg-blue-500 rounded-r-3xl lg:rounded-r-3xl xl:rounded-r-3xl 2xl:rounded-r-3xl text-xl lg:text-3xl xl:text-2xl 2xl:text-2xl py-2.5 px-5 my-auto" >
