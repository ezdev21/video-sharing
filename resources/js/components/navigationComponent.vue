<template>
 <div class="flex justify-between bg-gray-200 w-full shadow-xl py-1.5">
  <div class="flex">
    <div class="flex mx-3 p-1">
     <a href="/" class="my-auto">
      <svg xmlns="http://www.w3.org/2000/svg" class="font-semibold my-auto text-green-500 h-10 w-10 hover:text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="rounded-4xl my-auto py-auto mx-3">
      <form @submit.prevent="search" class="flex">
       ...
       <button type="submit" class="capitalize bg-green-500 rounded-r-3xl lg:rounded-r-3xl xl:rounded-r-3xl 2xl:rounded-r-3xl text-xl lg:text-3xl xl:text-2xl 2xl:text-2xl py-2.5 px-4 my-auto" >
    ...
    <div class="font-medium my-auto text-green-500 text-xl mx-5 hidden lg:inline xl:inline 2xl:inline">
   ...
   <div class="mx-3 my-auto"> 
     <div v-if="userId" class="my-auto hidden lg:inline xl:inline 2xl:inline">
       <button @click="userDropdownMenu=true" class="my-auto flex">
        <span class="text-xl font-semibold capitalize text-green-500 text-semibold">{{user.name}}</span>
        <svg xmlns="http://www.w3.org/2000/svg" class="font-medium my-auto text-green-500 h-8 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
        </svg>
       </button>   
     </div>
     <div v-else class="my-auto font-meduim flex text-white text-xl text-xl">
      <a href="/login" class="text-2xl text-white mx-2 my-auto px-4 py-2">sign in</a>
      <a href="/register" class="my-auto text-2xl my-auto text-green-500 bg-blue-100 mx-2 my-2 rounded-3xl px-4 py-2">sign up</a>  
     </div>
