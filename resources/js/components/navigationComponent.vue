<template>
 <div class="flex justify-between bg-green-500 w-full shadow-xl py-1">
  <div class="flex">
   ...
   <div class="mx-3 my-auto"> 
     ...
     <div v-else class="my-auto flex text-white text-xl text-xl">
      <a href="/login" class="text-2xl text-green-500 mx-2 my-auto px-4 py-2">sign in</a>
      <a href="/register" class="my-auto text-2xl my-auto text-white bg-green-500 mx-2 my-2 rounded-3xl px-4 py-2">sign up</a>  
     </div>
