<template>
 <div class="flex justify-between bg-blue-500 w-full shadow-xl py-1.5">
  <div class="flex">
    ...
    <div class="font-semibold my-auto text-white text-xl mx-5 hidden lg:inline xl:inline 2xl:inline">
     <ul class="flex list-style-none h-full">
      <li class="my-auto mx-2 h-full p-1"><a href="/channel/create" class="text-2xl my-auto text-white">create</a></li>
      <li class=" my-auto mx-2 h-full p-1"><a href="/video/upload" class="text-2xl my-auto white">upload</a></li>
      <li class="my-auto mx-2 h-full p-1"><a href="/collection" class="text-2xl my-auto text-white"></a></li>   
     </ul>   
    </div>
   ...
   <div class="mx-3 my-auto"> 
     ...
     <a href="/login" class="text-xl text-white mx-2 my-auto px-4 py-2">sign in</a>
     <a href="/register" class="my-auto text-xl my-auto text-white bg-blue-700 mx-2 my-2 rounded-3xl px-4 py-2">sign up</a>  
     </div> 
